 ...
 */
public class GetSolution extends Activity {

    Context c;
    public GetSolution(Context c){
        this.c = c ;
    }
    ...
    public static int getRatio(String s1, String s2, boolean debug) {
        ...
        Sets.SetView<String> restOfSet1 = Sets.difference(set1,intersection);

        // Sort it

        TreeSet<String> sortedRestOfSet1 = Sets.newTreeSet(restOfSet1);

        Sets.SetView<String> restOfSet2 = Sets.difference(set2,intersection);
